...
class Telagabiru extends StatefulWidget {
  const Telagabiru({super.key});

  @override
  State<Telagabiru> createState() => _TelagabiruState();
}

class _TelagabiruState extends State<Telagabiru> {
  @override
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: const DecorationImage(
                    image: AssetImage(
                        'assets/images/Telagabiru.jpg'), // Path benar
                    fit: BoxFit.cover,
                  ),
                ),
                child: Stack(
