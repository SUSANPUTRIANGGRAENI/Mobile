...
class Citambur extends StatefulWidget {
  const Citambur({super.key});

  @override
  State<Citambur> createState() => _CitamburState();
}

class _CitamburState extends State<Citambur> {
  @override
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: const DecorationImage(
                    image: AssetImage(
                        'assets/images/citambur.jpg'), // Path benar
                    fit: BoxFit.cover,
                  ),
                ),
                child: Stack(
